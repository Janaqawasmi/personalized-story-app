...
export default function ChipsRow({ ageRange, topicLabel }: ChipsRowProps) {
  ...
  // Only the badges that help a parent identify *this* story at a glance.
  // Secondary trust signals (AI personalization, preview-first, languages)
  // live in the features/trust row below the hero instead — see FeaturesGrid.
  return (
