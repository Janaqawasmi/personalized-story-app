...
export const STORY_BRIEF_UI_HE: StoryBriefUi = {
  ...
  SOMATIC_EXPRESSION_LABELS: {
    freezing_going_still: "הקפאה / עצירה",
    crying_clinging: "בכי / היצמדות",
    stomach_ache_feeling_sick: "כאב בטן / תחושת סחרחורת",
    heart_racing_cant_breathe: "דופק מהיר / קשה לנשום",
    restless_fidgety: "חוסר מנוחה / רגל רגועה / לא יכול לשבת",
    going_quiet_shutting_down: "מושתק / נסגר",
    tension_clenching: "מתח / אחיזה (לסת, אגרופים, כתפיים)",
    sweating_feeling_hot: "הזעה / תחושת חום",
  },
  COPING_TOOL_LABELS: {
    deep_breathing: "נשימות עמוקות",
    counting: "ספירה",
    grounding_through_senses: "הארקה דרך החושים",
    positive_self_talk: "דיבור עצמי חיובי",
    visualization: "דימוון",
    routine_awareness: "מודעות לשגרה",
    safe_person: "דמות בטוחה",
    comfort_object_or_memory: "חפץ או זיכרון מרגיע",
    asking_for_help: "לבקש עזרה",
  },
  COPING_TOOL_CATEGORIES_FEAR_ANXIETY: [
    { label: "גוף", tools: ["deep_breathing", "counting", "grounding_through_senses"] },
    { label: "נפש", tools: ["positive_self_talk", "visualization", "routine_awareness"] },
    { label: "קשר", tools: ["safe_person", "comfort_object_or_memory", "asking_for_help"] },
  ],
  RESOLUTION_LABELS: {
    full: "פתרון מלא",
    partial: "פתרון חלקי",
  ...
  CAREGIVER_PRESENCE_LABELS: {
    present_and_comforting: "נוכח ומנחם",
    guides_from_the_side: "מנחה מהצד",
    leaves_and_returns: "יוצא וחוזר",
    waiting_at_the_end: "ממתין בסוף",
    not_present: "לא נוכח",
  },
  ...
  s5IntroOn: "הסיפור מותאם אישית. הורים יכולים להתאים אותו עם שם הילד ותמונה.",
